...
"SequenceValueItem","ServerHitBin","ServerHitType","ServerHit","ServiceSemaphore","ShipmentGatewayDhl","ShipmentItemBilling","ShoppingListItemSurvey","ShoppingListItem","ShoppingListType","ShoppingListWorkEffort","ShoppingList","SubscriptionActivity","SubscriptionAttribute","SubscriptionCommEvent","SubscriptionFulfillmentPiece","SubscriptionResource","SubscriptionTypeAttr","SubscriptionType","Subscription","SupplierPrefOrder","SupplierProductFeature","SupplierProduct","SupplierRatingType","SurveyApplType","SurveyMultiRespColumn","SurveyMultiResp","SurveyPage","SurveyQuestionAppl","SurveyQuestionCategory","SurveyQuestionOption","SurveyQuestionType","SurveyQuestion","SurveyResponseAnswer","SurveyResponse","SurveyTrigger","Survey",
...
"X509IssuerProvision","UomType","GeoType","UomConversion","UomConversionDated",
