...
"QuantityBreakType","QuantityBreak","CountryAddressFormat","GeoAssocType","StatusValidChange",
...
"UserLoginHistory","UserAgentMethodType","UserAgentType","UserAgent","UserLoginHistory","UserLoginSecurityQuestion","UserLoginSession",
...
"WebAnalyticsConfig","WebAnalyticsType","WebPage","WebPreferenceType","WebSite","WebSiteCatalog","WebSiteContentType","WebSiteContent","WebSitePathAlias","WebSitePublishPoint","WebSiteRole","WebUserPreference","WorkEffortAssocAttribute","WorkEffortAssocTypeAttr","WorkEffortAssocType","WorkEffortAssoc","WorkEffortAttribute","WorkEffortBilling","WorkEffortContactMech","WorkEffortContentType","WorkEffortContent","WorkEffortDeliverableProd","WorkEffortEntityRel","WorkEffortEventReminder","WorkEffortFixedAssetAssign","WorkEffortFixedAssetStd","WorkEffortGoodStandardType","WorkEffortGoodStandard","WorkEffortPartyAssignment","WorkEffortPurposeType","WorkEffortStatus","WorkEffortType","WorkOrderItemFulfillment","WorkReqFulfType","WorkRequirementFulfillment",
...
<#macro "entity">
    ...
    <#if !excludedEntities?seq_contains(ename) && !skipEntity?seq_contains(ename)>
        <#if "UserPreference" == ename || "SequenceValueItem" == ename>
...
<#macro "relation">
        ...
        <#if packageName?has_content && 'WorkEffort' != relEntityName>
